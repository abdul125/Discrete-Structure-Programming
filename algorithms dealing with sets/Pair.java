...
/**
 * The Pair<X,Y> class is a generic class which wraps 2 object instances (of types
 * X and Y) in a single object.  Either or both of the values contained in the Pair
 * can be NULL (the hashCode() of a Pair containing two NULL values is 0, as is the case
 * with other classes in the JDK).
 *
 * @param <X>
 * @param <Y>
 */
public class Pair<X,Y>  {
    ...
    public boolean equals(Object o){
    	// if the references point to the same object (same memory location), return true
    	if (this == o)
    		return true;
    	...
    	// return true iff the first and second values are equal to those of the parameter
